...
public class DesignFoodRatingSystem {
    public static void main(String[] args) {
        String[] foods = {"Pizza", "Burger", "Sandwich", "Pasta", "Pasta", "Burger"};
        String[] cuisines = {"Italian", "American", "Italian", "Italian", "Italian", "American"};
        int[] ratings = {4, 5, 3, 2, 1, 1};

        FoodRatings foodRatings = new DesignFoodRatingSystem().new FoodRatings(foods, cuisines, ratings);

        System.out.println(foodRatings.highestRated("Italian"));
        System.out.println(foodRatings.highestRated("American"));

        foodRatings.changeRating("Pasta", 5);
